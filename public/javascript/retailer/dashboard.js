...
if(page === 'retailer-dashboard') page = 'DASHBOARD'
else if(page === 'retailer-profile') page = 'PROFILE'
else if(page === 'retailer-products') page = 'PRODUCT'
else if(page === 'retailer-cart') page = 'CART'
else if(page === 'retailer-orders') page = 'ORDERS'
